...
fn trace_msg(msg: u32) {
  let m = match msg {
    win32wm::WM_NULL => Some("WM_NULL"),
    win32wm::WM_CREATE => Some("WM_CREATE"),
    win32wm::WM_DESTROY => Some("WM_DESTROY"),
    win32wm::WM_MOVE => Some("WM_MOVE"),
    win32wm::WM_SIZE => Some("WM_SIZE"),
    win32wm::WM_ACTIVATE => Some("WM_ACTIVATE"),
    win32wm::WM_SETFOCUS => Some("WM_SETFOCUS"),
    win32wm::WM_KILLFOCUS => Some("WM_KILLFOCUS"),
    win32wm::WM_ENABLE => Some("WM_ENABLE"),
    win32wm::WM_SETREDRAW => Some("WM_SETREDRAW"),
    win32wm::WM_SETTEXT => Some("WM_SETTEXT"),
    win32wm::WM_GETTEXT => Some("WM_GETTEXT"),
    win32wm::WM_GETTEXTLENGTH => Some("WM_GETTEXTLENGTH"),
    win32wm::WM_PAINT => Some("WM_PAINT"),
    win32wm::WM_CLOSE => Some("WM_CLOSE"),
    win32wm::WM_QUERYENDSESSION => Some("WM_QUERYENDSESSION"),
    win32wm::WM_QUIT => Some("WM_QUIT"),
    win32wm::WM_QUERYOPEN => Some("WM_QUERYOPEN"),
    win32wm::WM_ERASEBKGND => Some("WM_ERASEBKGND"),
    win32wm::WM_SYSCOLORCHANGE => Some("WM_SYSCOLORCHANGE"),
    win32wm::WM_ENDSESSION => Some("WM_ENDSESSION"),
    win32wm::WM_SHOWWINDOW => Some("WM_SHOWWINDOW"),
    win32wm::WM_WININICHANGE => Some("WM_WININICHANGE"),
    win32wm::WM_DEVMODECHANGE => Some("WM_DEVMODECHANGE"),
    win32wm::WM_ACTIVATEAPP => Some("WM_ACTIVATEAPP"),
    win32wm::WM_FONTCHANGE => Some("WM_FONTCHANGE"),
    win32wm::WM_TIMECHANGE => Some("WM_TIMECHANGE"),
    win32wm::WM_CANCELMODE => Some("WM_CANCELMODE"),
    win32wm::WM_SETCURSOR => Some("WM_SETCURSOR"),
    win32wm::WM_MOUSEACTIVATE => Some("WM_MOUSEACTIVATE"),
    win32wm::WM_CHILDACTIVATE => Some("WM_CHILDACTIVATE"),
    win32wm::WM_QUEUESYNC => Some("WM_QUEUESYNC"),
    win32wm::WM_GETMINMAXINFO => Some("WM_GETMINMAXINFO"),
    win32wm::WM_PAINTICON => Some("WM_PAINTICON"),
    win32wm::WM_ICONERASEBKGND => Some("WM_ICONERASEBKGND"),
    win32wm::WM_NEXTDLGCTL => Some("WM_NEXTDLGCTL"),
    win32wm::WM_SPOOLERSTATUS => Some("WM_SPOOLERSTATUS"),
    win32wm::WM_DRAWITEM => Some("WM_DRAWITEM"),
    win32wm::WM_MEASUREITEM => Some("WM_MEASUREITEM"),
    win32wm::WM_DELETEITEM => Some("WM_DELETEITEM"),
    win32wm::WM_VKEYTOITEM => Some("WM_VKEYTOITEM"),
    win32wm::WM_CHARTOITEM => Some("WM_CHARTOITEM"),
    win32wm::WM_SETFONT => Some("WM_SETFONT"),
    win32wm::WM_GETFONT => Some("WM_GETFONT"),
    win32wm::WM_SETHOTKEY => Some("WM_SETHOTKEY"),
    win32wm::WM_GETHOTKEY => Some("WM_GETHOTKEY"),
    win32wm::WM_QUERYDRAGICON => Some("WM_QUERYDRAGICON"),
    win32wm::WM_COMPAREITEM => Some("WM_COMPAREITEM"),
    win32wm::WM_GETOBJECT => Some("WM_GETOBJECT"),
    win32wm::WM_COMPACTING => Some("WM_COMPACTING"),
    win32wm::WM_COMMNOTIFY => Some("WM_COMMNOTIFY"),
    win32wm::WM_WINDOWPOSCHANGING => Some("WM_WINDOWPOSCHANGING"),
    win32wm::WM_WINDOWPOSCHANGED => Some("WM_WINDOWPOSCHANGED"),
    win32wm::WM_POWER => Some("WM_POWER"),
    win32wm::WM_COPYDATA => Some("WM_COPYDATA"),
    win32wm::WM_CANCELJOURNAL => Some("WM_CANCELJOURNAL"),
    win32wm::WM_NOTIFY => Some("WM_NOTIFY"),
    win32wm::WM_INPUTLANGCHANGEREQUEST => Some("WM_INPUTLANGCHANGEREQUEST"),
    win32wm::WM_INPUTLANGCHANGE => Some("WM_INPUTLANGCHANGE"),
    win32wm::WM_TCARD => Some("WM_TCARD"),
    win32wm::WM_HELP => Some("WM_HELP"),
    win32wm::WM_USERCHANGED => Some("WM_USERCHANGED"),
    win32wm::WM_NOTIFYFORMAT => Some("WM_NOTIFYFORMAT"),
    win32wm::WM_CONTEXTMENU => Some("WM_CONTEXTMENU"),
    win32wm::WM_STYLECHANGING => Some("WM_STYLECHANGING"),
    win32wm::WM_STYLECHANGED => Some("WM_STYLECHANGED"),
    win32wm::WM_DISPLAYCHANGE => Some("WM_DISPLAYCHANGE"),
    win32wm::WM_GETICON => Some("WM_GETICON"),
    win32wm::WM_SETICON => Some("WM_SETICON"),
    win32wm::WM_NCCREATE => Some("WM_NCCREATE"),
    win32wm::WM_NCDESTROY => Some("WM_NCDESTROY"),
    win32wm::WM_NCCALCSIZE => Some("WM_NCCALCSIZE"),
    win32wm::WM_NCHITTEST => Some("WM_NCHITTEST"),
    win32wm::WM_NCPAINT => Some("WM_NCPAINT"),
    win32wm::WM_NCACTIVATE => Some("WM_NCACTIVATE"),
    win32wm::WM_GETDLGCODE => Some("WM_GETDLGCODE"),
    win32wm::WM_SYNCPAINT => Some("WM_SYNCPAINT"),
    win32wm::WM_NCMOUSEMOVE => Some("WM_NCMOUSEMOVE"),
    win32wm::WM_NCLBUTTONDOWN => Some("WM_NCLBUTTONDOWN"),
    win32wm::WM_NCLBUTTONUP => Some("WM_NCLBUTTONUP"),
    win32wm::WM_NCLBUTTONDBLCLK => Some("WM_NCLBUTTONDBLCLK"),
    win32wm::WM_NCRBUTTONDOWN => Some("WM_NCRBUTTONDOWN"),
    win32wm::WM_NCRBUTTONUP => Some("WM_NCRBUTTONUP"),
    win32wm::WM_NCRBUTTONDBLCLK => Some("WM_NCRBUTTONDBLCLK"),
    win32wm::WM_NCMBUTTONDOWN => Some("WM_NCMBUTTONDOWN"),
    win32wm::WM_NCMBUTTONUP => Some("WM_NCMBUTTONUP"),
    win32wm::WM_NCMBUTTONDBLCLK => Some("WM_NCMBUTTONDBLCLK"),
    win32wm::WM_NCXBUTTONDOWN => Some("WM_NCXBUTTONDOWN"),
    win32wm::WM_NCXBUTTONUP => Some("WM_NCXBUTTONUP"),
    win32wm::WM_NCXBUTTONDBLCLK => Some("WM_NCXBUTTONDBLCLK"),
    win32wm::SBM_SETPOS => Some("SBM_SETPOS"),
    win32wm::SBM_GETPOS => Some("SBM_GETPOS"),
    win32wm::SBM_SETRANGE => Some("SBM_SETRANGE"),
    win32wm::SBM_GETRANGE => Some("SBM_GETRANGE"),
    win32wm::SBM_ENABLE_ARROWS => Some("SBM_ENABLE_ARROWS"),
    win32wm::SBM_SETRANGEREDRAW => Some("SBM_SETRANGEREDRAW"),
    win32wm::SBM_SETSCROLLINFO => Some("SBM_SETSCROLLINFO"),
    win32wm::SBM_GETSCROLLINFO => Some("SBM_GETSCROLLINFO"),
    win32wm::SBM_GETSCROLLBARINFO => Some("SBM_GETSCROLLBARINFO"),
    win32wm::BM_GETCHECK => Some("BM_GETCHECK"),
    win32wm::BM_SETCHECK => Some("BM_SETCHECK"),
    win32wm::BM_GETSTATE => Some("BM_GETSTATE"),
    win32wm::BM_SETSTATE => Some("BM_SETSTATE"),
    win32wm::BM_SETSTYLE => Some("BM_SETSTYLE"),
    win32wm::BM_CLICK => Some("BM_CLICK"),
    win32wm::BM_GETIMAGE => Some("BM_GETIMAGE"),
    win32wm::BM_SETIMAGE => Some("BM_SETIMAGE"),
    win32wm::BM_SETDONTCLICK => Some("BM_SETDONTCLICK"),
    win32wm::WM_INPUT => Some("WM_INPUT"),
    win32wm::WM_KEYDOWN => Some("WM_KEYDOWN"),
    win32wm::WM_KEYUP => Some("WM_KEYUP"),
    win32wm::WM_CHAR => Some("WM_CHAR"),
    win32wm::WM_DEADCHAR => Some("WM_DEADCHAR"),
    win32wm::WM_SYSKEYDOWN => Some("WM_SYSKEYDOWN"),
    win32wm::WM_SYSKEYUP => Some("WM_SYSKEYUP"),
    win32wm::WM_SYSCHAR => Some("WM_SYSCHAR"),
    win32wm::WM_SYSDEADCHAR => Some("WM_SYSDEADCHAR"),
    win32wm::WM_UNICHAR => Some("WM_UNICHAR"),
    win32wm::WM_IME_STARTCOMPOSITION => Some("WM_IME_STARTCOMPOSITION"),
    win32wm::WM_IME_ENDCOMPOSITION => Some("WM_IME_ENDCOMPOSITION"),
    win32wm::WM_IME_COMPOSITION => Some("WM_IME_COMPOSITION"),
    win32wm::WM_INITDIALOG => Some("WM_INITDIALOG"),
    win32wm::WM_COMMAND => Some("WM_COMMAND"),
    win32wm::WM_SYSCOMMAND => Some("WM_SYSCOMMAND"),
    win32wm::WM_TIMER => Some("WM_TIMER"),
    win32wm::WM_HSCROLL => Some("WM_HSCROLL"),
    win32wm::WM_VSCROLL => Some("WM_VSCROLL"),
    win32wm::WM_INITMENU => Some("WM_INITMENU"),
    win32wm::WM_INITMENUPOPUP => Some("WM_INITMENUPOPUP"),
    win32wm::WM_MENUSELECT => Some("WM_MENUSELECT"),
    win32wm::WM_MENUCHAR => Some("WM_MENUCHAR"),
    win32wm::WM_ENTERIDLE => Some("WM_ENTERIDLE"),
    win32wm::WM_MENURBUTTONUP => Some("WM_MENURBUTTONUP"),
    win32wm::WM_MENUDRAG => Some("WM_MENUDRAG"),
    win32wm::WM_MENUGETOBJECT => Some("WM_MENUGETOBJECT"),
    win32wm::WM_UNINITMENUPOPUP => Some("WM_UNINITMENUPOPUP"),
    win32wm::WM_MENUCOMMAND => Some("WM_MENUCOMMAND"),
    win32wm::WM_CHANGEUISTATE => Some("WM_CHANGEUISTATE"),
    win32wm::WM_UPDATEUISTATE => Some("WM_UPDATEUISTATE"),
    win32wm::WM_QUERYUISTATE => Some("WM_QUERYUISTATE"),
    win32wm::WM_CTLCOLORMSGBOX => Some("WM_CTLCOLORMSGBOX"),
    win32wm::WM_CTLCOLOREDIT => Some("WM_CTLCOLOREDIT"),
    win32wm::WM_CTLCOLORLISTBOX => Some("WM_CTLCOLORLISTBOX"),
    win32wm::WM_CTLCOLORBTN => Some("WM_CTLCOLORBTN"),
    win32wm::WM_CTLCOLORDLG => Some("WM_CTLCOLORDLG"),
    win32wm::WM_CTLCOLORSCROLLBAR => Some("WM_CTLCOLORSCROLLBAR"),
    win32wm::WM_CTLCOLORSTATIC => Some("WM_CTLCOLORSTATIC"),
    win32wm::WM_MOUSEMOVE => Some("WM_MOUSEMOVE"),
    win32wm::WM_LBUTTONDOWN => Some("WM_LBUTTONDOWN"),
    win32wm::WM_LBUTTONUP => Some("WM_LBUTTONUP"),
    win32wm::WM_LBUTTONDBLCLK => Some("WM_LBUTTONDBLCLK"),
    win32wm::WM_RBUTTONDOWN => Some("WM_RBUTTONDOWN"),
    win32wm::WM_RBUTTONUP => Some("WM_RBUTTONUP"),
    win32wm::WM_RBUTTONDBLCLK => Some("WM_RBUTTONDBLCLK"),
    win32wm::WM_MBUTTONDOWN => Some("WM_MBUTTONDOWN"),
    win32wm::WM_MBUTTONUP => Some("WM_MBUTTONUP"),
    win32wm::WM_MBUTTONDBLCLK => Some("WM_MBUTTONDBLCLK"),
    win32wm::WM_MOUSEWHEEL => Some("WM_MOUSEWHEEL"),
    win32wm::WM_XBUTTONDOWN => Some("WM_XBUTTONDOWN"),
    win32wm::WM_XBUTTONUP => Some("WM_XBUTTONUP"),
    win32wm::WM_XBUTTONDBLCLK => Some("WM_XBUTTONDBLCLK"),
    win32wm::WM_MOUSEHWHEEL => Some("WM_MOUSEHWHEEL"),
    win32wm::WM_PARENTNOTIFY => Some("WM_PARENTNOTIFY"),
    win32wm::WM_ENTERMENULOOP => Some("WM_ENTERMENULOOP"),
    win32wm::WM_EXITMENULOOP => Some("WM_EXITMENULOOP"),
    win32wm::WM_NEXTMENU => Some("WM_NEXTMENU"),
    win32wm::WM_SIZING => Some("WM_SIZING"),
    win32wm::WM_CAPTURECHANGED => Some("WM_CAPTURECHANGED"),
    win32wm::WM_MOVING => Some("WM_MOVING"),
    win32wm::WM_POWERBROADCAST => Some("WM_POWERBROADCAST"),
    win32wm::WM_DEVICECHANGE => Some("WM_DEVICECHANGE"),
    win32wm::WM_MDICREATE => Some("WM_MDICREATE"),
    win32wm::WM_MDIDESTROY => Some("WM_MDIDESTROY"),
    win32wm::WM_MDIACTIVATE => Some("WM_MDIACTIVATE"),
    win32wm::WM_MDIRESTORE => Some("WM_MDIRESTORE"),
    win32wm::WM_MDINEXT => Some("WM_MDINEXT"),
    win32wm::WM_MDIMAXIMIZE => Some("WM_MDIMAXIMIZE"),
    win32wm::WM_MDITILE => Some("WM_MDITILE"),
    win32wm::WM_MDICASCADE => Some("WM_MDICASCADE"),
    win32wm::WM_MDIICONARRANGE => Some("WM_MDIICONARRANGE"),
    win32wm::WM_MDIGETACTIVE => Some("WM_MDIGETACTIVE"),
    win32wm::WM_MDISETMENU => Some("WM_MDISETMENU"),
    win32wm::WM_ENTERSIZEMOVE => Some("WM_ENTERSIZEMOVE"),
    win32wm::WM_EXITSIZEMOVE => Some("WM_EXITSIZEMOVE"),
    win32wm::WM_DROPFILES => Some("WM_DROPFILES"),
    win32wm::WM_MDIREFRESHMENU => Some("WM_MDIREFRESHMENU"),
    win32wm::WM_IME_SETCONTEXT => Some("WM_IME_SETCONTEXT"),
    win32wm::WM_IME_NOTIFY => Some("WM_IME_NOTIFY"),
    win32wm::WM_IME_CONTROL => Some("WM_IME_CONTROL"),
    win32wm::WM_IME_COMPOSITIONFULL => Some("WM_IME_COMPOSITIONFULL"),
    win32wm::WM_IME_SELECT => Some("WM_IME_SELECT"),
    win32wm::WM_IME_CHAR => Some("WM_IME_CHAR"),
    win32wm::WM_IME_REQUEST => Some("WM_IME_REQUEST"),
    win32wm::WM_IME_KEYDOWN => Some("WM_IME_KEYDOWN"),
    win32wm::WM_IME_KEYUP => Some("WM_IME_KEYUP"),
    win32wm::WM_NCMOUSEHOVER => Some("WM_NCMOUSEHOVER"),
    0x02a1 => Some("WM_MOUSEHOVER"),
    win32wm::WM_NCMOUSELEAVE => Some("WM_NCMOUSELEAVE"),
    0x02a3 => Some("WM_MOUSELEAVE"),
    win32wm::WM_CUT => Some("WM_CUT"),
    win32wm::WM_COPY => Some("WM_COPY"),
    win32wm::WM_PASTE => Some("WM_PASTE"),
    win32wm::WM_CLEAR => Some("WM_CLEAR"),
    win32wm::WM_UNDO => Some("WM_UNDO"),
    win32wm::WM_RENDERFORMAT => Some("WM_RENDERFORMAT"),
    win32wm::WM_RENDERALLFORMATS => Some("WM_RENDERALLFORMATS"),
    win32wm::WM_DESTROYCLIPBOARD => Some("WM_DESTROYCLIPBOARD"),
    win32wm::WM_DRAWCLIPBOARD => Some("WM_DRAWCLIPBOARD"),
    win32wm::WM_PAINTCLIPBOARD => Some("WM_PAINTCLIPBOARD"),
    win32wm::WM_VSCROLLCLIPBOARD => Some("WM_VSCROLLCLIPBOARD"),
    win32wm::WM_SIZECLIPBOARD => Some("WM_SIZECLIPBOARD"),
    win32wm::WM_ASKCBFORMATNAME => Some("WM_ASKCBFORMATNAME"),
    win32wm::WM_CHANGECBCHAIN => Some("WM_CHANGECBCHAIN"),
    win32wm::WM_HSCROLLCLIPBOARD => Some("WM_HSCROLLCLIPBOARD"),
    win32wm::WM_QUERYNEWPALETTE => Some("WM_QUERYNEWPALETTE"),
    win32wm::WM_PALETTEISCHANGING => Some("WM_PALETTEISCHANGING"),
    win32wm::WM_PALETTECHANGED => Some("WM_PALETTECHANGED"),
    win32wm::WM_HOTKEY => Some("WM_HOTKEY"),
    win32wm::WM_PRINT => Some("WM_PRINT"),
    win32wm::WM_PRINTCLIENT => Some("WM_PRINTCLIENT"),
    win32wm::WM_APPCOMMAND => Some("WM_APPCOMMAND"),
    win32wm::WM_HANDHELDFIRST => Some("WM_HANDHELDFIRST"),
    win32wm::WM_HANDHELDLAST => Some("WM_HANDHELDLAST"),
    win32wm::WM_AFXFIRST => Some("WM_AFXFIRST"),
    win32wm::WM_AFXLAST => Some("WM_AFXLAST"),
    win32wm::WM_PENWINFIRST => Some("WM_PENWINFIRST"),
    win32wm::WM_PENWINLAST => Some("WM_PENWINLAST"),
    win32wm::WM_APP => Some("WM_APP"),
    _ => None,
  };
  if let Some(m) = m {
    println!("{}", m);
